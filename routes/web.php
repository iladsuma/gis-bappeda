...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/map/lokasi-ipal', [MapController::class, 'lokasi_ipal'])->name('map.lokasi-ipal');
    ...
    Route::delete('/data-lokasi-spam/{id}/drop', [DataLokasiSpamController::class, 'drop'])->name('data-lokasi-spam.drop'); //->can('Data Pendukung.Lokasi Spam');

    // Data Lokasi SPAM
    Route::get('/data-lokasi-ipal', [DataLokasiIpalController::class, 'index'])->name('data-lokasi-ipal.index'); //->can('Data Pendukung.Lokasi Spam');
    Route::get('/data-lokasi-ipal/datatable', [DataLokasiIpalController::class, 'datatable'])->name('data-lokasi-ipal.datatable'); //->can('Data Pendukung.Lokasi Spam');
    Route::post('/data-lokasi-ipal/store', [DataLokasiIpalController::class, 'store'])->name('data-lokasi-ipal.store'); //->can('Data Pendukung.Lokasi Spam');
    Route::get('/data-lokasi-ipal/{id}/edit', [DataLokasiIpalController::class, 'edit'])->name('data-lokasi-ipal.edit'); //->can('Data Pendukung.Lokasi Spam');
    Route::put('/data-lokasi-ipal/{id}/update', [DataLokasiIpalController::class, 'update'])->name('data-lokasi-ipal.update'); //->can('Data Pendukung.Lokasi Spam');
    Route::delete('/data-lokasi-ipal/{id}/drop', [DataLokasiIpalController::class, 'drop'])->name('data-lokasi-ipal.drop'); //->can('Data Pendukung.Lokasi Spam');
