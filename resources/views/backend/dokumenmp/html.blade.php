<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body ">
                <button class="btn btn-primary ml-2 mb-2" id="tambah-data">+ Data Dokumen MasterPlan</button>
                <table id="table-dokumen-mp" class="table table-stripped">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Judul Kegiatan</th>
                            <th>Pelaksana Kegiatan</th>
                            <th>Lokasi Kegiatan Mp</th>
                            <th>Tahun</th>
                            <th>Dokumen</th>
                            <th>Aksi</th>
                            <th></th>
